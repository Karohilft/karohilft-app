...
-- Schritt A: Zuerst unter /login registrieren (oder Auth → Add User in Supabase)
-- Schritt B: Dann hier deine User-ID eintragen:

-- INSERT INTO karohilft_users (id, email, full_name, role)
-- SELECT id, email, raw_user_meta_data->>'full_name', 'admin'
-- FROM auth.users
-- WHERE email = 'deine@email.at'  -- ← hier deine E-Mail eintragen
-- ON CONFLICT (id) DO UPDATE SET role = 'admin';

-- Oder direkt über caregivers-Tabelle (Admin-Check läuft darüber):
